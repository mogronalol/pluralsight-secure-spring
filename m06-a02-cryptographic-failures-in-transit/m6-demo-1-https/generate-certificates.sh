...
keytool -genkeypair -alias demo -keyalg EC -groupname secp256r1 -keystore src/main/resources/demo-keystore.p12 -storetype PKCS12 -validity 365 -dname "CN=localhost, OU=Dev, O=MyCompany, L=City, ST=State, C=US" -storepass notsecure -keypass notsecure
