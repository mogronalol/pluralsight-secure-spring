...
public class TransactionPermissionTestArgumentProvider extends RoleBasedArgumentsProvider {
    ...
    public Stream<? extends Arguments> provideArguments(ExtensionContext context) {
        ...
        final TransactionAmounts annotation = context.getRequiredTestMethod().getAnnotation(TransactionAmounts.class);
        ...
        return arguments
                .flatMap(a -> Stream.of(transactionAmounts).map(amount -> Arguments.of(a.get()[0], a.get()[1], new BigDecimal(amount))));
    }
}